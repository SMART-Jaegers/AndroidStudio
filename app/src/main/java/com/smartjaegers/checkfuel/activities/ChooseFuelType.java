...
public class ChooseFuelType extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView textViewNameStation, textView1, textView2, textView3, textView4, textView5, textView6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewNameStation = findViewById(R.id.nameStation);
    ...
    protected void onStart() {
        ...
        textViewNameStation.setText(nameStation);
