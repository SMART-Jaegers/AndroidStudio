...
public class WarningAdapter extends RecyclerView.Adapter<ViewOfItemStatistic> {
    ...
    public WarningAdapter(List<Refill> refills, List<DayOfUse> daysOfUse, Context context) {
